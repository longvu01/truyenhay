...
<head>
	...
	<style type="text/css">
		...
		#div_giua>.giua>.dieu_khien_1>button{
			/*text-align: center;*/
			background: #ff6122;
			color: #E4E6EB;
			width: 200px;
		...
		#div_giua>.giua>.dieu_khien_2>button{
			/*text-align: center;*/
			background: #ff6122;
			color: #E4E6EB;
			width: 200px;
	...
	<div id="div_tong">
		...
		<div id="div_giua">
			...
			<div class="giua">
				...
				<div class="ten_chuong">
				 Chương 1: Đến vương quốc sa mạc
				</div>
				<div id="trang_tri">
				<img src="https://cdn.glitch.me/f33bc0c9-9283-443f-af3b-b6ef40f9c179%2FLovepik_com-401562052-decorative-pattern.png?v=1639266672074">
				</div>
				<div class="dieu_khien_1">
					<button>
						Chương trước
					</button>
					<button class="danh_sach_chuong" style="width: 70px">
